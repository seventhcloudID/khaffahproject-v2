...
const Footer = () => {
  ...
  return (
    <div>
      <Screen className="py-14 px-4 bg-white" id="contact_section">
        <div className="flex flex-col lg:flex-row gap-14 w-full">
          <div className="space-y-4 w-full lg:w-1/4 xl:w-1/5">
            ...
            <div className="space-y-3">
              <div className="flex gap-4 w-full">
                ...
                <div>
                  <p className="text-khaffah-neutral-dark text-xs md:text-sm">
                    WhatsApp
                  </p>
                  <p className="text-xs md:text-sm lg:text-16">
                    +62 896 7777 1070
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm lg:text-16">
                    safarkhadamat@gmail.com
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="pt-1">
                  <Icon name="Location" className="fill-khaffah-primary" />
                </div>
                <div>
                  <p className="text-khaffah-neutral-dark text-xs md:text-sm">
                    Alamat Kantor
                  ...
                  <p className="text-xs md:text-sm lg:text-16">
                    18 Office Tower, Jkt, IDN
                  </p>
                </div>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 md:gap-8 lg:gap-4  w-full">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <Icon name="ListPointer" className="" />
                  <Link href={"/"}>
                    <p className="text-xs text-khaffah-primary border-b border-khaffah-primary">
                      Umrah Private
                    </p>
                  </Link>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <Icon name="ListPointer" className="" />
                  <Link href={"/"}>
                    <p className="text-xs whitespace-nowrap text-khaffah-primary border-b border-khaffah-primary">
                      Paket Land Arragement
                    </p>
                  </Link>
                </div>
                <div className="flex items-center gap-4">
            ...
            <div className="space-y-4">
              <p className="text-sm md:text-16 lg:text-20 whitespace-nowrap font-bold">
                Informasi Penting
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
            ...
            <div className="space-y-4 hidden lg:block">
              <p className="text-sm md:text-16 lg:text-20 font-bold opacity-0">
                -
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
      ...
      <hr className="border-dashed border-khaffah-neutral-mid" />
      <Screen className="pt-8 pb-20 px-4 bg-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Icon name="Copyright" className="" />
            <p className="text-khaffah-neutral-dark font-bold  text-xs md:text-sm lg:text-16">{`${date} Kaffah Khadamat Tour. All right reserved`}</p>
          </div>
          <div>
            <Link
              href={"/"}
              className="w-16 md:w-24 lg:w-36 md:flex items-center relative justify-center hidden"
            >
              <svg
                width="158"
                height="48"
