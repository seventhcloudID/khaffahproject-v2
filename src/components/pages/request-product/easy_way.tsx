        ...
        <div className="w-full lg:w-[70%] xl:w-[60%] space-y-8">
          <div>
            ...
            <p className="text-sm text-khaffah-neutral-dark">
              Ikuti panduan sederhana kami untuk mengajukan permintaan Umrah
              Private yang sepenuhnya disesuaikan dengan kebutuhan Anda.
            </p>
          </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-sm md:text-16 lg:text-20 text-black font-bold">
                  {`Isi Formulir Preferensi`}
                </p>
                <p className="text-10 md:text-12 lg:text-14">
                  Lengkapi detail perjalanan yang Anda impikan, termasuk
                  tanggal, jumlah jemaah, dan destinasi pilihan.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-sm md:text-16 lg:text-20 text-black font-bold">
                  {`Konsultasi & Penawaran Eksklusif`}
                </p>
                <p className="text-10 md:text-12 lg:text-14">
                  Tim ahli kami akan menghubungi Anda untuk memahami kebutuhan
                  lebih lanjut dan menyiapkan penawaran terbaik.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-sm md:text-16 lg:text-20 text-black font-bold">
                  {`Konfirmasi & Nikmati Perjalanan Anda`}
                </p>
                <p className="text-10 md:text-12 lg:text-14">
                  Setujui rencana perjalanan, selesaikan konfirmasi, dan siapkan
                  diri untuk perjalanan ibadah yang tak terlupakan!
                </p>
              </div>
            </div>
          </div>
...
export default RequestProjectEasyWay;
